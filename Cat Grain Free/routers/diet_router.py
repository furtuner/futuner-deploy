...
def user_ingredients():
    ...
    category_display = {
        ...
        "Grain A":             "06 Grain A (Mandatory - Select at least one and a maximum of three, fixed at 110g) [Quinoa, Tapioca, Potatoes, Sweet Potatoes]",
        ...
        "Fruit":               "09 Fruit (Optional - Select upto three maximum)",
...
<body>
  <h1>Cat Diet Planner - Grain Free</h1>
...
<body>
  <div class="container">
    ...
    <div class="subtitle">Fresh weights and daily feeding plan for your homemade cat grain-free diet recipe</div>
...
def _generate_aafco_report(ingredients: List[str]):
    ...
    for category, nutrients in nutrients_config.items():
        ...
        for nutrient_tuple in nutrients:
            # 5-element tuple: no max; 6-element: has max
